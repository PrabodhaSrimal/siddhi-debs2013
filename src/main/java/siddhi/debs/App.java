...
import org.wso2.siddhi.core.treaser.PassThrewEventMonitor;
import org.wso2.siddhi.core.util.EventPrinter;
import org.wso2.siddhi.query.api.definition.Attribute;
import org.wso2.siddhi.query.compiler.exception.SiddhiPraserException;

import siddhi.debs.FileFeeder;
...
public class App 
{
	...
	private void SetupStream()
	{
		...
		String sEventMonitor = System.getProperty("siddhi.EventMonitor", "PassThrewEventMonitor");
        ...
        {
        	m_EventMonitor = new PassThrewEventMonitor();
        }
        else
        {
        ...
        try
        {
        	m_InputHandler = m_SiddhiManager.defineStream("define stream GameStream (" +
        			"sid int, " +
        			"timestamp long, " +
        			"pos_x int, " +
        			"pos_y int, " +
        ...
        catch(SiddhiPraserException ex)
        {
        	ex.printStackTrace();
        }
